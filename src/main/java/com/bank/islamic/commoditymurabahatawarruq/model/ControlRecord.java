package com.bank.islamic.commoditymurabahatawarruq.model;
...
/**
 * The BIAN control record for this service domain: "Tawarruq Transaction Procedure".
 *
 ...
 * to its asset type (Tawarruq Transaction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Tawarruq Transaction Procedure";
